...
scanf("%s", ch);
printf("Enter starting delimiter string or character:");
scanf("%s", header);
printf("Enter ending delimiter string or character:");
scanf("%s", trailer);
printf("Enter character or string that is to be stuffed:");
scanf("%s", add);
